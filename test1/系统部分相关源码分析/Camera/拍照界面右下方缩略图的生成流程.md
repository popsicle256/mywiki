...
ThumbnailViewManager.updateThumbnail()中bitmap的来源，主要为更新相机拍照界面UI中的缩略图，用于确保在 UI 线程上更新缩略图，以避免在 Android 应用程序中引发与 UI 操作相关的问题。    
...
故初步怀疑缩略图异常问题由此处的尺寸变化引起，故进行下述分析：  
...
#### 1.3.1.2 BitmapCreator.covertYuvDataToJpeg();
